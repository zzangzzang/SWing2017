...
public class LineView extends View {
    ...
    private int topLineLength = MyUtils.dip2px(getContext(), 6); // | | ←this
    //-+-+-
    private int sideLineLength = MyUtils.dip2px(getContext(),30)/3*2;// --+--+--+--+--+--+--
    //  ↑this
    private int backgroundGridWidth = MyUtils.dip2px(getContext(),32);
    ...
    //custom --
    private boolean isCustomVertical = false;
    ...
    public void setDataOfAGird(int dataOfAGird) {
        this.dataOfAGird = dataOfAGird;
    ...
    public void setCustomVerticalGrid(boolean isCustomVertical, int count) {
        this.isCustomVertical = isCustomVertical;
